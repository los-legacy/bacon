node('chris') {
   withEnv([
      ...
      'ROMTYPE="unofficial',
      'VERSION=17.1',
      'LOCAL_MANIFESTS_URL=https://raw.githubusercontent.com/los-legacy/local_manifests/lineage-17.1/bacon.xml',
      ...
      stage('Preparation') { // for display purposes
         sh """#!/bin/bash
            ...
            wget $env.LOCAL_MANIFESTS_URL -O $env.SYSTEM_PATH/$env.LOCAL_MANIFESTS_PATH/bacon.xml
         """
      }
